...
#ifndef MUSKETEER_TRANSLATOR_POWERGRAPH_H
#define MUSKETEER_TRANSLATOR_POWERGRAPH_H
...
#include "translation/powergraph_job_code.h"
...
class TranslatorPowerGraph : public TranslatorGraphInterface {
 public:
  TranslatorPowerGraph(const op_nodes& dag, const string& class_name);
 ...
 private:
  ...
  string GenPreGroupUnion(OperatorInterface* op);
