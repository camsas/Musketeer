...
#ifndef MUSKETEER_HADOOP_JOB_CODE_H
#define MUSKETEER_HADOOP_JOB_CODE_H
...
class HadoopJobCode : public MapReduceJobCode {
 public:
  HadoopJobCode(OperatorInterface* op, const string& map_variables_code_,
  ...
  HadoopJobCode(OperatorInterface* op, const string& code):
