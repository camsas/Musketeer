...
#ifndef MUSKETEER_SPARK_JOB_CODE_H
#define MUSKETEER_SPARK_JOB_CODE_H
...
class SparkJobCode : public JobCode {
 public:
  SparkJobCode(OperatorInterface* op, const string& code): JobCode(op, code) {
  }
