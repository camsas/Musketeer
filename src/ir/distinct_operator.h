...
#ifndef MUSKETEER_DISTINCT_OPERATOR_H
#define MUSKETEER_DISTINCT_OPERATOR_H
...
class DistinctOperator : public OperatorInterface {
 public:
  DistinctOperator(const string& input_dir, const vector<Relation*>& relations,
                   Relation* output_rel):
