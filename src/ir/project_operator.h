...
#ifndef MUSKETEER_PROJECT_OPERATOR_H
#define MUSKETEER_PROJECT_OPERATOR_H
...
class ProjectOperator : public OperatorInterface {
 public:
  ProjectOperator(const string& input_dir,
  ...
  ProjectOperator(const string& input_dir, ConditionTree* condition_tree,
                  const vector<Relation*>& relations,
                  const vector<Column*>& columns_,
                  Relation* output_relation):
