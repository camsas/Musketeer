...
#ifndef MUSKETEER_INPUT_OPERATOR_H
#define MUSKETEER_INPUT_OPERATOR_H
...
class InputOperator : public OperatorInterface {
 public:
  InputOperator(const string& input_dir, const vector<Relation*>& relations,
                Relation* output_rel):
