...
#ifndef MUSKETEER_INTERSECTION_OPERATOR_H
#define MUSKETEER_INTERSECTION_OPERATOR_H
...
class IntersectionOperator : public OperatorInterface {
 public:
  IntersectionOperator(const string& input_dir,
