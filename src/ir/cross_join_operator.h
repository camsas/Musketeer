...
#ifndef MUSKETEER_CROSS_JOIN_OPERATOR_H
#define MUSKETEER_CROSS_JOIN_OPERATOR_H
...
class CrossJoinOperator: public OperatorInterface {
 public:
  CrossJoinOperator(const string& input_dir, const vector<Relation*>& relations,
